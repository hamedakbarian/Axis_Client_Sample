...
public class DivorcesInfo  implements java.io.Serializable {
    private Services.DivorceInfo[] divorces;
     ...
     * @return divorces
     */
    public Services.DivorceInfo[] getDivorces() {
        return divorces;
    }
     ...
     * @param divorces
     */
    public void setDivorces(Services.DivorceInfo[] divorces) {
        this.divorces = divorces;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getDivorces() != null) {
            for (int i=0;
                 ...
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getDivorces(), i);
                if (obj != null &&
