...
public class ServicesServiceLocator extends org.apache.axis.client.Service implements Services.ServicesService {
    ...
    private java.lang.String Services_address = "http://localhost:7001/DcuS/services/Services";
    ...
    public Services.Services_PortType getServices(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Services.ServicesSoapBindingStub _stub = new Services.ServicesSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Services.Services_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                Services.ServicesSoapBindingStub _stub = new Services.ServicesSoapBindingStub(new java.net.URL(Services_address), this);
                _stub.setPortName(getServicesWSDDServiceName());
                return _stub;
            }
        }
