...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements Axis.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:7001/Apache_Axis_Sample/services/HelloWorld";
    ...
    public Axis.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public Axis.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Axis.HelloWorldSoapBindingStub _stub = new Axis.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Axis.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                Axis.HelloWorldSoapBindingStub _stub = new Axis.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
